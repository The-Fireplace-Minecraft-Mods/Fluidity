...
public class GUIFluidityChest extends GuiContainer {
	...
	public enum GUI {
		...
		public static GUIFluidityChest buildGUI(FluidityIronChestType type, IInventory playerInventory, TileEntityFluidityIronChest chestInventory)
		{
			return new GUIFluidityChest(values()[chestInventory.getType().ordinal()], playerInventory, chestInventory);
		}
	}
	...
	private GUIFluidityChest(GUI type, IInventory player, IInventory chest)
	{
