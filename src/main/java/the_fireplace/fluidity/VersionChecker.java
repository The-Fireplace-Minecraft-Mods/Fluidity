...
public class VersionChecker {
	private static final String HostMODID=Fluidity.MODID;
	private static final String HostMODNAME=Fluidity.MODNAME;
	private static final String HostVERSION=Fluidity.VERSION;
	static final String MODID=Fluidity.MODID+"vc";
	static final String MODNAME=Fluidity.MODNAME+" Version Checker";
	static final String VERSION="1.0";
	private String latest;
	private String downloadURL;

	public VersionChecker(){
		latest = stringAt(Fluidity.LATEST);//The link to the url leading to a text file with the latest version number
		downloadURL = stringAt(Fluidity.DOWNLOADURL);//A link to a text file with the url to the mod's download page
	}
